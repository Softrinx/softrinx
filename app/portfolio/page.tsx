...
const SELLING = [
  ...
  { num: "04", title: "From Vision. For Everyone.. For the world.", body: "We're CS graduates from DeKUT, Westlands, Nairobi — building products used in Kenya, Germany, and beyond. World-class engineering doesn't require a zip code." },
];
