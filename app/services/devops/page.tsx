...
import { 
  GitBranch, Server, CheckCircle2, ArrowRight,
  Sparkles, Shield, Zap, Settings,
  Rocket, Cloud, Database, Layers
} from "lucide-react";
...
export default function DevOpsPage() {
  ...
  const services = [
    {
      ...
      description: "Automate your build, test, and deployment processes for faster releases.",
      features: ["Automated testing", "Continuous integration", "Automated deployments", "Pipeline optimization"]
    },
    {
      icon: <Cloud className="w-10 h-10" />,
      title: "Infrastructure as Code",
      description: "Manage and provision infrastructure using code for consistency and reliability.",
      features: ["Terraform", "Ansible", "CloudFormation", "Infrastructure automation"]
    },
    {
      icon: <Server className="w-10 h-10" />,
      title: "Container Orchestration",
      description: "Deploy and manage containerized applications at scale.",
      features: ["Kubernetes", "Docker", "Container management", "Auto-scaling"]
    },
    {
      icon: <Shield className="w-10 h-10" />,
      title: "DevOps Security",
      description: "Integrate security into your DevOps pipeline from the start.",
      features: ["Security scanning", "Secrets management", "Compliance", "Vulnerability management"]
    }
  ];
  ...
  return (
    <main className="bg-white">
        ...
        <div className="container mx-auto px-4 relative z-20 pt-32 pb-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">
              Streamline Your <span className="bg-gradient-to-r from-emerald-400 via-cyan-400 to-blue-500 bg-clip-text text-transparent">Development Pipeline</span>
            </h1>
            
            <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
              Automate deployments, optimize infrastructure, and accelerate delivery with expert DevOps practices.
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className={`text-center mb-16 transform transition-all duration-1000 ${isServicesInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                From CI/CD to infrastructure automation, we help you build efficient development pipelines.
              </p>
            </div>
      ...
      {/* Tools Section */}
      <section ref={toolsRef} className="py-24 bg-gradient-to-br from-gray-50 to-emerald-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className={`text-center mb-16 transform transition-all duration-1000 ${isToolsInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h2 className="text-4xl md:text-5xl font-bold mb-6">
                DevOps Tools & Technologies
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                We work with industry-leading tools and platforms to deliver best-in-class DevOps solutions.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              {tools.map((tool, idx) => (
                <div
                  key={idx}
                  className={`px-6 py-3 bg-white rounded-xl border-2 border-gray-100 hover:border-emerald-300 hover:shadow-lg transition-all duration-300 ${isToolsInView ? 'opacity-100 scale-100' : 'opacity-0 scale-90'}`}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className={`text-xl mb-12 text-white/90 max-w-2xl mx-auto transform transition-all duration-1000 delay-300 ${isCtaInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              Let's discuss how DevOps practices can accelerate your development and deployment processes.
            </p>
