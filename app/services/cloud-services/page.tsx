...
import { 
  Cloud, Server, CheckCircle2, ArrowRight,
  Sparkles, Database, Zap, Shield,
  Globe, Settings, TrendingUp, Rocket
} from "lucide-react";
...
export default function CloudServicesPage() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Design scalable, resilient cloud architectures for your business needs.",
      features: ["Architecture design", "Scalability planning", "High availability", "Cost optimization"]
    },
    {
      icon: <Zap className="w-10 h-10" />,
      title: "DevOps & CI/CD",
      description: "Automate deployments and streamline your development workflow.",
    ...
    },
    {
      ...
      features: ["Security audits", "Compliance", "Identity management", "Threat detection"]
    }
  ];
  ...
  return (
    <main className="bg-white">
        ...
        <div className="container mx-auto px-4 relative z-20 pt-32 pb-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">
              Scale with <span className="bg-gradient-to-r from-emerald-400 via-cyan-400 to-blue-500 bg-clip-text text-transparent">Cloud Power</span>
            </h1>
            
            <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
              Transform your infrastructure with scalable cloud solutions that grow with your business.
            </p>
      ...
      {/* Platforms Section */}
      <section ref={platformsRef} className="py-24 bg-gradient-to-br from-gray-50 to-emerald-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className={`text-center mb-16 transform transition-all duration-1000 ${isPlatformsInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h2 className="text-4xl md:text-5xl font-bold mb-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {platforms.map((platform, idx) => (
                <div
                  key={idx}
                  className={`text-center p-8 bg-white rounded-2xl border-2 border-gray-100 hover:border-emerald-300 hover:shadow-lg transition-all duration-500 ${isPlatformsInView ? 'opacity-100 scale-100' : 'opacity-0 scale-90'}`}
                  style={{ transitionDelay: `${idx * 100}ms` }}
                >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className={`text-xl mb-12 text-white/90 max-w-2xl mx-auto transform transition-all duration-1000 delay-300 ${isCtaInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              Let's discuss how cloud solutions can transform your business infrastructure.
            </p>
