...
import { 
  Code, Layers, CheckCircle2, ArrowRight,
  Sparkles, GitBranch, Server, Database,
  Globe, Zap, Rocket, Settings
} from "lucide-react";
...
export default function SoftwareDevelopmentPage() {
  ...
  const services = [
    {
      ...
      features: ["React, Next.js, Vue", "Full-stack development", "Progressive Web Apps"]
    },
    {
      icon: <Server className="w-10 h-10" />,
      title: "Backend Systems",
      description: "Scalable server-side solutions and microservices architecture.",
      features: ["Microservices", "REST & GraphQL APIs", "Cloud-native architecture"]
    },
    {
      icon: <Database className="w-10 h-10" />,
      title: "Database Solutions",
      description: "Robust database design and optimization for performance at scale.",
  ...
  const process = [
    ...
    },
    {
      number: "02",
      title: "Design",
      description: "Architecture design and technical specification development.",
        ...
        <div className="container mx-auto px-4 relative z-20 pt-32 pb-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">
              Build <span className="bg-gradient-to-r from-emerald-400 via-cyan-400 to-blue-500 bg-clip-text text-transparent">Powerful Software</span> Solutions
            </h1>
            
            <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
              Transform your ideas into scalable, high-performance software applications that drive business growth.
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className={`text-center mb-16 transform transition-all duration-1000 ${isServicesInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                From web applications to enterprise systems, we deliver end-to-end software solutions.
              </p>
            </div>
