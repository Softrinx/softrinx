...
export default function MobileDevelopmentPage() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "PWAs that deliver app-like experiences through web browsers.",
      features: ["Offline support", "Push notifications", "App-like experience", "Easy deployment"]
    }
  ];
        ...
        <div className="container mx-auto px-4 relative z-20 pt-32 pb-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">
              Build <span className="bg-gradient-to-r from-emerald-400 via-cyan-400 to-blue-500 bg-clip-text text-transparent">Mobile Apps</span> That Users Love
            </h1>
          ...
          <div className="max-w-6xl mx-auto">
            <div className={`text-center mb-16 transform transition-all duration-1000 ${isServicesInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                From native apps to cross-platform solutions, we build mobile experiences that engage users.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className={`text-xl mb-12 text-white/90 max-w-2xl mx-auto transform transition-all duration-1000 delay-300 ${isCtaInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              Let's create a mobile app that engages users and drives business results.
            </p>
